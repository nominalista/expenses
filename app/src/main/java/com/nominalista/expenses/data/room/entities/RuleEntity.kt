...
data class RuleEntity(
    ...
    fun mapToRule() = Rule(id = id.toString(), name = name, firstSymbol = firstSymbol, lastSymbol = lastSymbol, decimalSeparator = decimalSeparator, groupSeparator = groupSeparator)
    ...
    companion object {
        ...
        fun fromRule(rule: Rule) = RuleEntity(id = rule.id.toLong(), name = rule.name, firstSymbol = rule.firstSymbol, lastSymbol = rule.lastSymbol, decimalSeparator = rule.decimalSeparator, groupSeparator = rule.groupSeparator)
    }
}